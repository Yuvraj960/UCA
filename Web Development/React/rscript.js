...
// root.render(<DescriptionComponent name = "Yuvraj" />); //these are js not html
...
// name = "Valid modified name"  //this should not be done js allows this but in react why would u want to
...
// React.useState() - used for managing the state of the component. First element is the state of the component and second is the func that changes the state
