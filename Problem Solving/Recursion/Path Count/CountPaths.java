 ...
 */
 ...
 public class CountPaths {
  ...
  public int countPaths(int m, int n, int x, int y) {
    ...
    // Move left (closer to column 0)
    if (y > 0) {
      paths = paths + countPaths(m, n, x, y - 1);
    }
    
    // Move up (closer to row 0)
    if (x > 0) {
      paths = paths + countPaths(m, n, x - 1, y);
    }
